...
const publicFiles = new Set(['/index.html','/style.css','/app.js','/core.mjs',...['hall','brute','lizard','wraith','knight','gear','hero','guards','frost','spider','demon','relics'].map(name=>`/assets/${name}.png`)]);
